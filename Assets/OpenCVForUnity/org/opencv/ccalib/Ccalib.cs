...
namespace OpenCVForUnity
{
		public class Ccalib
		{
				...
				//
				// C++:  double calibrate(Mat objectPoints, Mat imagePoints, Size size, Mat& K, Mat& xi, Mat& D, vector_Mat& rvecs, vector_Mat& tvecs, int flags, TermCriteria criteria, Mat& idx = Mat())
				//
        ...
        double retVal = ccalib_Ccalib_calibrate_10(objectPoints.nativeObj, imagePoints.nativeObj, size.width, size.height, K.nativeObj, xi.nativeObj, D.nativeObj, rvecs_mat.nativeObj, tvecs_mat.nativeObj, flags, criteria.type, criteria.maxCount, criteria.epsilon, idx.nativeObj);
