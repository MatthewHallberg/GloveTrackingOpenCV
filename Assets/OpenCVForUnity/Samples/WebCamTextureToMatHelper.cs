...
/// </summary>
		public class WebCamTextureToMatHelper  : MonoBehaviour
		{
				...
				/// </summary>
				private string requestDeviceName;//keep null or empty
				...
				/// </summary>
				private bool requestIsFrontFacing = false;
...
//								OnDisposedEvent = new UnityEvent ();
					...
					Init (requestDeviceName,screenWidth,screenHeight,false);
				}
				...
				public void Init (string deviceName, int requestWidth, int requestHeight, bool requestIsFrontFacing)
				{
						...
						this.screenWidth = 1280;//Screen.width
						this.screenHeight = 720;//Screen.height
...
//			Debug.Log ("deviceName is "+requestDeviceName);
								webCamTexture = new WebCamTexture (requestDeviceName, screenWidth, screenHeight);
						} else {
...
//					Debug.Log (cameraIndex + " name " + WebCamTexture.devices [cameraIndex].name + " isFrontFacing " + WebCamTexture.devices [cameraIndex].isFrontFacing);
												...
												webCamTexture = new WebCamTexture (webCamDevice.name, screenWidth, screenHeight);
...
//			Debug.Log ("webCamTexture is null");
								if (WebCamTexture.devices.Length > 0) {
										...
										webCamTexture = new WebCamTexture (screenWidth, screenHeight);
								}
						}
